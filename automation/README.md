...
Visit https://xuvish.github.io/agra-nagar-nigam-ots-2026/ots/ and click **Update Dashboard**. An embedded local page (127.0.0.1 only) requests your government ID/password and your *separate* dashboard administrator ID/password. The **government portal password** stays in the local helper and visible official portal browser. The **separate dashboard admin password** is used for the existing dashboard login and authenticated publish endpoint. Neither is stored in the repository. The parent public page cannot inspect the localhost login form. If Chrome blocks the embedded local page, choose **Open local helper** and use the same form directly at http://127.0.0.1:8765/control.

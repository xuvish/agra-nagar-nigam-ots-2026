...
async function showZone(z){
 ...
 const html=summary([
  ...
  ['Online Paid',money(o.amount)],['Total Collection (receipt zone)',money(m.total)],['Ward detail (property)',money(wards.reduce((a,r)=>a+N(r.collection),0))],['Zone/ward basis difference',money(m.total-wards.reduce((a,r)=>a+N(r.collection),0))],['Today Collection',money(m.today)],['Today Receipts',number(m.todayReceipts)]
 ])+

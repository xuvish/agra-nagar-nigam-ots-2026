...
(async()=>{
 try{
  ...
  await load('assets/fix-engine-v3.js?v=20260918-0825-engine-v4');
  await load('assets/fix-admin-production-v7.js?v=20260918-0825-admin-v7b');
  ...
  await load('assets/fix-collection-authority-v2.js?v=20260918-0625-collection-v2');
  await load('assets/fix-shared-live-v7.js?v=20260918-0805-production-v7');

...
(async()=>{
 try{
  ...
  await load('assets/fix-engine-v3.js?v=20260924-ledger-v8');
  await load('assets/fix-admin-production-v7.js?v=20260918-0840-admin-v7c');
  await load('assets/ots-seven-pdf.js?v=20260924-crosspage-v7');
  await load('assets/fix-smart-upload.js?v=20260924-seven-pdf-v6');
  ...
  await load('assets/fix-collection-authority-v2.js?v=20260924-ledger-v8');
  await load('assets/fix-shared-live-v8.js?v=20260924-ledger-v8');
  ...
  await load('assets/ots-seven-pdf-audit.js?v=20260924-seven-pdf-v6');

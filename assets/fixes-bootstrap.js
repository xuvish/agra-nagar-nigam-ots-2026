...
(async()=>{
 try{
  ...
  await load('assets/ots-seven-pdf.js?v=20260925-resilient-pdf-v17');
  await load('assets/fix-smart-upload.js?v=20260925-resilient-pdf-v17');
  ...
  await load('assets/fix-shared-live-v8.js?v=20260925-live-cache-fix-v25');
  await load('assets/fix-property-contact-master.js?v=20260925-ward-guard-v24');
  ...
  await load('assets/fix-persist-v8.js?v=20260925-masterreceipt-v20');
